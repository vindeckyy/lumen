    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                dashboard: resolve(assetsSrcPath, 'dashboard.html'),
                ...
                profiles: resolve(assetsSrcPath, 'profiles.html'),
                'codec-presets': resolve(assetsSrcPath, 'codec-presets.html'),
                sessions: resolve(assetsSrcPath, 'sessions.html'),
                'sf-clients': resolve(assetsSrcPath, 'sf-clients.html'),
                'sf-health': resolve(assetsSrcPath, 'sf-health.html'),
                'sf-network': resolve(assetsSrcPath, 'sf-network.html'),
                troubleshooting: resolve(assetsSrcPath, 'troubleshooting.html'),
                welcome: resolve(assetsSrcPath, 'welcome.html'),
                wizard: resolve(assetsSrcPath, 'wizard.html'),
            },
        },
    },
})
